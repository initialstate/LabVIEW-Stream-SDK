	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Initial State SDK" Type="Folder">
			...
			<Item Name="Data Helpers" Type="Folder">
				...
				<Item Name="IS PolyVI Instance DBL To JSON Cluster .vi" Type="VI" URL="../Initial State LabVIEW SDK/IS PolyVI Instance DBL To JSON Cluster .vi"/>
			...
			<Item Name="IS Create Bucket.vi" Type="VI" URL="../Initial State LabVIEW SDK/IS Create Bucket.vi"/>
		...
		<Item Name="Initial State Example.vi" Type="VI" URL="../Initial State Example.vi"/>
